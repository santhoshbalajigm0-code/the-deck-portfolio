...
export const HobbiesDeck: React.FC = () => {
  ...
  return (
    <section id="hobbies" className="min-h-[70vh] flex flex-col items-center justify-center py-16 px-4 relative">
          ...
          {hobbies.map((hobby, idx) => (
            ...
            >
              <PlayingCard
                ...
                tiltIntensity={14}
              >
                <div className="flex-1 flex flex-col justify-between py-2 text-center text-slate-900">
                  ...
                  <div className="flex flex-col items-center my-auto">
                    <div className="w-16 h-16 rounded-2xl bg-amber-50 border border-amber-900/10 shadow flex items-center justify-center mb-2">
